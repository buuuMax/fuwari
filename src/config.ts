...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/buuuMax", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://steamcommunity.com/profiles/76561199874296740/",
		},
		{
			name: "GitHub",
